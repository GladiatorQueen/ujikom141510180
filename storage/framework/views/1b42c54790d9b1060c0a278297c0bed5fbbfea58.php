...
<div class="container">
    ...
    <br>
        ...
        <div class="col-md-10">
            <div class="panel panel-primary">
                <div class="panel-heading"> <center><h3>Tunjangan</h3></center></div>  
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<td><center><a href="<?php echo e(route('tunjangan.edit', $data->id)); ?>" class="btn btn-warning"><li class="mdi mdi-lg mdi-pencil"></li></a></center></td>
				<td><center>
